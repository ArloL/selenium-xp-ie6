...
wget --continue --timestamping http://selenium-release.storage.googleapis.com/2.47/selenium-server-standalone-2.47.1.jar
shasum --check selenium-server-standalone-2.47.1.jar.sha1

wget --continue --timestamping http://selenium-release.storage.googleapis.com/2.47/IEDriverServer_Win32_2.47.0.zip
...
wget --continue --no-cookies --header="Cookie: oraclelicense=accept-securebackup-cookie" --output-document=jre-8u60-windows-i586.exe http://download.oracle.com/otn-pub/java/jdk/8u60-b27/jre-8u60-windows-i586.exe
shasum --check jre-8u60-windows-i586.exe.sha1

wget --continue --no-cookies --header="Cookie: oraclelicense=accept-securebackup-cookie" --output-document=jre-8u60-windows-x64.exe http://download.oracle.com/otn-pub/java/jdk/8u60-b27/jre-8u60-windows-x64.exe
